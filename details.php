	...
	<script>
        $(document).ready(function() {
            $('#deliverButton').on('click', function(e) {
                ...
                $.post('deliver_status.php', { id: id, status: status })
...
<body>
	...
	<div class="single-product mt-150 mb-150">
        <div class="container">
            <div class="row">
                ...
                $sql = "SELECT image,id,amount,payment_id FROM orders WHERE id = $id";
    ...
    if ($result->num_rows > 0) {
		while ($row = $result->fetch_assoc()) {
			...
			echo ' <p class="single-product-pricing"><span>Amount Paid</span> Rs.' . $row['amount'] . '</p>';
		  
			echo ' <div class="single-product-form">';
			echo '   <p><strong>Payment ID: </strong>' . $row['payment_id'] . '</p>';
			echo '<a href="" class="cart-btn" id="deliverButton">Deliver</a>';
